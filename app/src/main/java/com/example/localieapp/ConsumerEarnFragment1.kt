...
import com.example.localieapp.adapter.EarnGridAdapter1
 ...
 */
class ConsumerEarnFragment1 : Fragment() {
...
//    private var isActive: Boolean = false
    ...
    private lateinit var earnGridAdapter: EarnGridAdapter1
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_consumer_earn1, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        dataset = ArrayList()
        earnGridAdapter = EarnGridAdapter1(requireContext(), dataset)
